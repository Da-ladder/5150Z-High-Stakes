...
void Routes::skills() {
    ...
    // prep for wall stake
    robot.turn_with_pid(202.53, 400);
    ...
    pros::delay(150);
    IntakeHelper::voltage(12);
    moveManual(450, -7); //370
    moveManual(200, -5.8); //240
    robot.restOdomKeepAngle(54.58, 58.48);
    LiftMngr::setLevel(SCORE_HEIGHT+20);
    moveManual(10, -5.5);
    pros::delay(50);
    pros::delay(300);
    ...
    IntakeHelper::voltage(12);
    moveManual(400, 5.7); // 100, 5
    // moveManual(400, 4);// 400 4
    ...
    // get stake
    robot.turn_with_pid(85.9, 600); //88.9
    IntakeHelper::voltage(-6);
    LiftMngr::setLevel(ABOVE_IN_HEIGHT);
    IntakeHelper::stuckCheckChange(true);
    pros::delay(150);
    IntakeHelper::voltage(12);
    moveManual(400, -7); // 370 -6
    moveManual(250, -5); // 250 -5.5
    ...
    moveManual(230, -4);
    robot.ffwLat((au::inches)(7), (au::seconds)(1));
    ...
    // back off
    robot.ffwLat((au::inches)(5), (au::seconds)(1)); // just back off more once done
    // robot.move_to_point({(au::inches)(92.56), (au::inches)(0.83)}, false, MOGO_SIDE, 800, 2.7); //700 NOT NEEDED?
    LiftMngr::setLevel(IDLE_ARM);
    ...
    moveManual(500, -6.5); //900 -6.5
    moveManual(400, -10, -5); //NEW
    ...
    moveManual(600, 11.4); //550 10 TESTTT
    // moveManual(1300, 10);
...
void Routes::placehold1() {
    ...
    LiftMngr::setLevel(IDLE_ARM);
    pros::delay(50);
    robot.turn_with_pid(50.5, 300); //300, 55
    pros::delay(40);
    MogoUtils::getMogo(8, 7, 12, 320, 1);
    MogoUtils::getMogo(5, 3, 6, 1000, 26);
    IntakeHelper::voltage(12);
    ...
    robot.turn_with_pid(175, 700); // +3
    IntakeHelper::StopAtColor(false);
    IntakeHelper::voltage(12);
    robot.move_to_point({(au::inches)(38.55), (au::inches)(15.45)}, false, INTAKE_SIDE, 700, 2.9);

    // go twds corner
    robot.turn_with_pid(125, 480); //110
    cornerDeploy.overrideState(1);
    moveManual(175, -6);
    pros::delay(40);
    robot.turn_with_pid(-10, 280); //275
    cornerDeploy.overrideState(0); 

    // get corner
    // robot.turn_to_point({(au::inches)(34.21), (au::inches)(-14.79)}, INTAKE_SIDE, 650); /*
    robot.turn_with_pid(80.85, 600); //600, 76.61
    robot.move_to_point({(au::inches)(37.69), (au::inches)(-15.75)}, false, INTAKE_SIDE, 550, 2.9);
    robot.turn_with_pid(101.46, 460); // 400, 102.1
    IntakeHelper::stuckCheckChange(false);
    IntakeHelper::blueExcld(true);
    IntakeHelper::sortState(false);
    IntakeHelper::StopAtColor(true);
    ...
    cornerDeploy.overrideState(1);
    pros::delay(285); //250
    moveManual(160, -8, -11); // 400, 11, 3
    // pros::delay(100); //250
    // IntakeHelper::voltage(0);
    robot.turn_with_pid(286.67, 850); //1250 +5
    IntakeHelper::voltage(0);
    cornerDeploy.overrideState(0);
    robot.turn_with_pid(286.67, 500); //+5
    moClamp.overrideState(0);
    moveManual(400, 11); 
    ...
    //New way of touching ladder
    LiftMngr::setLevel(STRAIGHT_ARM+35);
    IntakeHelper::StopAtColor(false);
    //robot.move_to_point({(au::inches)(24.72), (au::inches)(-27.83)}, true, INTAKE_SIDE, 600, 2.9); 
    robot.turn_to_point({(au::inches)(24.72), (au::inches)(27.83)},  INTAKE_SIDE, 600);
    IntakeHelper::voltage(-12);
    moveManual(805, -10);
...
void Routes::placehold1Mir() {
    ...
    // get corner
    // robot.turn_to_point({(au::inches)(34.21), (au::inches)(-14.79)}, INTAKE_SIDE, 650); /*
    //robot.turn_with_pid(-81.87, 600); // {(au::inches)(32.99), (au::inches)(11.04)} Good Pt
    
    
    robot.move_to_point({(au::inches)(31.66), (au::inches)(16.80)}, true, INTAKE_SIDE, 600, 2.9); //32.99, 11.04
    robot.turn_with_pid(-102.5, 450); // 400 (-104.1)
    IntakeHelper::stuckCheckChange(false);
    IntakeHelper::blueExcld(false);
    IntakeHelper::sortState(false);
    IntakeHelper::StopAtColor(true);
    ...
    cornerDeploy.overrideState(1);
    pros::delay(200); //500
    moveManual(200, -8, -6); //400, -10, -3
    pros::delay(100);
    robot.turn_with_pid(82.5, 851); //70.5 1250
    IntakeHelper::voltage(0);
    cornerDeploy.overrideState(0);
    robot.turn_with_pid(82.5, 501);
    moClamp.overrideState(0);
    moveManual(400, 11);
    //IntakeHelper::voltage(-12);
...
void Routes::placehold2() {
    ...
    // turn twds other ring -126.31
    robot.turn_with_pid(-126.31, 800);
    IntakeHelper::StopAtColor(false);
    IntakeHelper::voltage(12);
    robot.move_to_point({(au::inches)(28.16), (au::inches)(10.98)}, false, INTAKE_SIDE, 800, 2.9);


    // go twds corner
    robot.turn_with_pid(-50.25, 450);
    cornerDeploy.overrideState(1);
    moveManual(250, -4.75); //longer? 350
    pros::delay(60);
    robot.turn_with_pid(20, 281);
    cornerDeploy.overrideState(0);

    // get corner
    // robot.turn_to_point({(au::inches)(9.60), (au::inches)(31.22)}, INTAKE_SIDE, 650);
    robot.turn_with_pid(-52, 651);
    robot.move_to_point({(au::inches)(6.95), (au::inches)(33.84)}, false, INTAKE_SIDE, 650, 2.9);
    robot.turn_with_pid(-72.32, 500);
    ...
    pros::delay(250);
    moveManual(400, -10, -3);
    robot.turn_with_pid(114, 900); //1250
    IntakeHelper::voltage(0);
    robot.turn_with_pid(114, 500);
    moClamp.overrideState(0);
    moveManual(400, 11);
    cornerDeploy.overrideState(0);
    ...
    // QUALS ENDING :3
    robot.turn_to_point({(au::inches)(23.76), (au::inches)(-8.46)}, INTAKE_SIDE, 400);
    LiftMngr::setLevel(STRAIGHT_ARM+30);
    robot.move_to_point({(au::inches)(23.76), (au::inches)(-8.46)}, false, INTAKE_SIDE, 650, 2.9);
...
void Routes::placehold2Mir() {
    ...
    // turn twds other ring
    robot.turn_with_pid(129.15, 800);
    // robot.turn_to_point({(au::inches)(31.84), (au::inches)(-10.32)}, INTAKE_SIDE, 800);
    IntakeHelper::StopAtColor(false);
    IntakeHelper::voltage(12);
    robot.move_to_point({(au::inches)(29.72), (au::inches)(-12.51)}, false, INTAKE_SIDE, 800, 2.9);
    ...
    // get corner
    // robot.turn_to_point({(au::inches)(10.42), (au::inches)(-29.71)}, INTAKE_SIDE, 550); /*
    robot.turn_with_pid(34.05, 550);
    robot.move_to_point({(au::inches)(8.77), (au::inches)(-34.99)}, false, INTAKE_SIDE, 550, 2.9);
    robot.turn_with_pid(68, 500);
    IntakeHelper::stuckCheckChange(false);
    IntakeHelper::blueExcld(true);
    IntakeHelper::sortState(false);
    IntakeHelper::StopAtColor(true);
    ...
    //QUALS ENDING :3
    cornerDeploy.overrideState(0);
    robot.turn_to_point({(au::inches)(22.72), (au::inches)(6.82)}, INTAKE_SIDE, 700);
    IntakeHelper::voltage(12);
    LiftMngr::setLevel(STRAIGHT_ARM+30);
    robot.move_to_point({(au::inches)(22.72), (au::inches)(6.82)}, false, INTAKE_SIDE, 650, 2.9);
    /**/
}
...
void Routes::placehold3() {
    ...
    robot.turn_with_pid(-153.75, 600); //660 x or y -?
    robot.move_to_point({(au::inches)(51.05), (au::inches)(-28.1)}, false, INTAKE_SIDE, 0, 3);

    // curve back and get other ring
    moveManual(100, 6, 6); // 2nd RING BACK 80
    ...
    robot.move_to_point({(au::inches)(35.71), (au::inches)(-17.95)}, false, INTAKE_SIDE, 0, 2.8);
    //    robot.move_to_point({(au::inches)(34.39), (au::inches)(-19.38)}, false, INTAKE_SIDE, 0, 2.8); //OLD

    // get corner
    robot.turn_with_pid(-82.9, 840);
    // robot.turn_to_point({(au::inches)(31.07), (au::inches)(16.35)},  INTAKE_SIDE, 840); //OLD
    robot.move_to_point({(au::inches)(34.4), (au::inches)(14.87)}, false, INTAKE_SIDE, 700, 3); //900
    robot.turn_with_pid(-101.3, 670);
    IntakeHelper::blueExcld(true);
    IntakeHelper::sortState(false);
    IntakeHelper::StopAtColor(true);
    IntakeHelper::stuckCheckChange(false);
    ...
    robot.turn_with_pid(43, 670);
    // IntakeHelper::voltage(12);
    IntakeHelper::StopAtColor(true);
    //robot.turn_to_point({(au::inches)(-1.36), (au::inches)(-8.7)},  INTAKE_SIDE, 840); //OLD
    liftIntake.overrideState(1);
    robot.move_to_point({(au::inches)(2.32), (au::inches)(-10.38)}, false, INTAKE_SIDE, 700, 2.95); //900
    
    robot.turn_with_pid(101.50, 670); //98.5
    liftIntake.overrideState(0);
    LiftMngr::setLevel(STRAIGHT_ARM+30);
    robot.chassis.left_motors.raw.set_brake_mode_all(pros::MotorBrake::coast);
    robot.chassis.left_motors.raw.set_brake_mode_all(pros::MotorBrake::coast);
...
void Routes::placehold3Mir() {
    ...
    // curve back and get other ring
    moveManual(225, 6, 6); // 2nd RING BACK 150
    moveManual(400, 2, 9); // 2nd RING BACK
    moveManual(250, 5, 5); // 240
    pros::delay(70);

    // get ring
    robot.turn_with_pid(146.47, 640);
    robot.move_to_point({(au::inches)(41.58), (au::inches)(16.34)}, false, INTAKE_SIDE, 0, 2.8);

    // get corner
    robot.turn_with_pid(80.58, 710);
    // robot.turn_to_point({(au::inches)(38.53), (au::inches)(-15.66)},  INTAKE_SIDE, 700); //OLD
    robot.move_to_point({(au::inches)(38.12), (au::inches)(-19.61)}, false, INTAKE_SIDE, 700, 3); //900
    robot.turn_with_pid(101.27, 510);
    IntakeHelper::sortState(false);
    IntakeHelper::blueExcld(false);
    IntakeHelper::stuckCheckChange(false);
    IntakeHelper::StopAtColor(true);
    ...
    // go twds ring
    robot.move_to_point({(au::inches)(8.47), (au::inches)(6.99)}, false, INTAKE_SIDE, 700, 2.7); //900
...
void Routes::placehold5() {
    ...
    // get corner
    robot.turn_with_pid(-79.5, 840);
    // robot.turn_to_point({(au::inches)(31.07), (au::inches)(16.35)},  INTAKE_SIDE, 840); //OLD
    robot.move_to_point({(au::inches)(34.4), (au::inches)(14.87)}, false, INTAKE_SIDE, 700, 3); //900
    robot.turn_with_pid(-102.3, 670);
    IntakeHelper::blueExcld(true);
    IntakeHelper::sortState(false);
    IntakeHelper::StopAtColor(true);
    IntakeHelper::stuckCheckChange(false);
    ...
    robot.turn_with_pid(44, 700); // get mid
    // IntakeHelper::voltage(12);
    IntakeHelper::StopAtColor(true);
    //robot.turn_to_point({(au::inches)(-1.36), (au::inches)(-8.7)},  INTAKE_SIDE, 840); //OLD
    liftIntake.overrideState(1);
    ...
    moveManual(150, -6);
    pros::delay(600);
    // robot.move_to_point({(au::inches)(2.32), (au::inches)(-10.38)}, false, INTAKE_SIDE, 700, 2.95); //PT FOR MID RING
...
void Routes::placehold5Mir() {
    ...
    moveManual(150, -6);
    // pros::delay(100); // TEST
    // robot.move_to_point({(au::inches)(8.47), (au::inches)(6.99)}, false, INTAKE_SIDE, 700, 2.7); //900 OLD PT
    ...
    moveManual(350, -12);
    liftIntake.overrideState(0);
    // moveManual(350, 12, -12); // no more curve
    // moClamp.overrideState(0);
    // pros::delay(50);
    // moveManual(150, 12, 3);
    moveManual(200, -12, -6); //12, 6
    // moveManual(500, 3, 12); //9, 12
...
void Routes::oldplacehold6() {
    ...
    // curve back and get other ring
    moveManual(30, 6, 6); // 2nd RING BACK 0
    moveManual(370, 9.5, 1.5); // 2nd RING BACK //400,9,2
    moveManual(300, 5, 5); //260
    // pros::delay(70);
    ...
    // IntakeHelper::blueExcld(true);
    // IntakeHelper::StopAtColor(true);
    // IntakeHelper::voltage(12); //{(au::inches)(-1.46), (au::inches)(-23.26)} //OLD {(au::inches)(1.13), (au::inches)(-22.15)} //NEW
...
void Routes::oldplacehold6Mir() {
    ...
    IntakeHelper::StopAtColor(true);
    //IntakeHelper::voltage(12);
    robot.move_to_point({(au::inches)(40.4), (au::inches)(17.36)}, false, INTAKE_SIDE, 0, 2.8);
    
    // get center stack & curve?
    robot.turn_with_pid(-5.25, 750);
    IntakeHelper::StopAtColor(false);
    IntakeHelper::voltage(12);
    ...
    // {(au::inches)(0.73), (au::inches)(23.29)} OLD
    // {(au::inches)(5.66), (au::inches)(21.61)} New-ish

    robot.move_to_point({(au::inches)(10.93), (au::inches)(20.46)}, false, INTAKE_SIDE, 0, 2.8); //2.75, 23.26
    IntakeHelper::blueExcld(false);
    IntakeHelper::sortState(false);
    IntakeHelper::StopAtColor(true);
    moveManual(250, -6);
    ...
    // touch ladder
    robot.turn_with_pid(-190, 890);
    IntakeHelper::StopAtColor(false);
    IntakeHelper::voltage(12);
    LiftMngr::setLevel(STRAIGHT_ARM+22);
    robot.move_to_point({(au::inches)(-5.38), (au::inches)(58.94)}, false, INTAKE_SIDE, 680, 2.8);
    LiftMngr::setLevel(STRAIGHT_ARM+10);
...
void Routes::placehold7() {
    ...
    // get corner
    robot.turn_with_pid(79.1, 600); //550
    robot.move_to_point({(au::inches)(34.67), (au::inches)(-13.45)}, false, INTAKE_SIDE, 550, 2.9);
    robot.turn_with_pid(100.97, 460); // 400
    IntakeHelper::stuckCheckChange(false);
    IntakeHelper::blueExcld(true);
    IntakeHelper::sortState(false);
    IntakeHelper::StopAtColor(true);
    ...
    moveManual(400, -10, -3);
    // IntakeHelper::voltage(0);
    robot.turn_with_pid(283.67, 850); //1250
    IntakeHelper::voltage(0);
    cornerDeploy.overrideState(0);
    robot.turn_with_pid(283.67, 500);
    moClamp.overrideState(0);
    moveManual(400, 11);
    ...
    //ELIMS ENDING
    cornerDeploy.overrideState(0);
    robot.turn_to_point({(au::inches)(48.00), (au::inches)(0.13)}, MOGO_SIDE, 900); 
    //robot.chassis.left_motors.raw.set_brake_mode_all(pros::MotorBrake::coast);
    //robot.chassis.left_motors.raw.set_brake_mode_all(pros::MotorBrake::coast);
    moveManual(500, 12); // test
    //29.16, 29.82
...
void Routes::placehold7Mir() {
    ...
    // turn twds other ring
    // robot.turn_to_point({(au::inches)(37.57), (au::inches)(14.81)}, INTAKE_SIDE, 700); /* //800 162.2
    robot.turn_with_pid(-167.95, 700); // -164.95
    IntakeHelper::StopAtColor(false);
    IntakeHelper::voltage(12);
    robot.move_to_point({(au::inches)(38.55), (au::inches)(-15.45)}, false, INTAKE_SIDE, 700, 2.9);

    // go twds corner
    robot.turn_with_pid(-78.72, 500); //480
    cornerDeploy.overrideState(1);
    moveManual(50, -6); 
    pros::delay(50);
    robot.turn_with_pid(15, 275);
    ...
    // get corner
    // robot.turn_to_point({(au::inches)(31.66), (au::inches)(16.80)}, INTAKE_SIDE, 650); /*
    robot.turn_with_pid(-81.9, 600); // {(au::inches)(32.99), (au::inches)(11.04)} Good Pt
    
    
    robot.move_to_point({(au::inches)(32.50), (au::inches)(15.57)}, false, INTAKE_SIDE, 600, 2.9); //32.99, 11.04
    robot.turn_with_pid(-100.87, 450); // 400 (-104.1)
    IntakeHelper::stuckCheckChange(false);
    IntakeHelper::blueExcld(false);
    IntakeHelper::sortState(false);
    IntakeHelper::StopAtColor(true);
    ...
    // robot.turn_with_pid(-80, 750); //750
    robot.turn_to_point({(au::inches)(53.37), (au::inches)(-8.01)}, MOGO_SIDE, 900); //32.99, 11.04
    IntakeHelper::voltage(-12);
    moveManual(400, 12);
...
void Routes::placehold12() {
    ...
    */
    ...
    robot.turn_with_pid(133.46, 400);
    moveManual(500, -10);
    robot.turn_with_pid(330.38, 1000);
    cornerDeploy.overrideState(0);

    /**
    //ELIMS ENDING
    cornerDeploy.overrideState(0);
    robot.turn_to_point({(au::inches)(31.44), (au::inches)(20.71)}, MOGO_SIDE, 900);
    //robot.chassis.left_motors.raw.set_brake_mode_all(pros::MotorBrake::coast);
    //robot.chassis.left_motors.raw.set_brake_mode_all(pros::MotorBrake::coast);
    moveManual(700, 8);
    robot.turn_with_pid(-23.2, 600);
    moveManual(200, 8);
    //29.16, 29.82
...
void Routes::placehold12Mir() {
    ...
    // elim ending
    // cornerDeploy.overrideState(0);
    robot.turn_with_pid(200.5, 400);
    moveManual(500, -10);
    // robot.move_to_point({(au::inches)(26.41), (au::inches)(-31.56)}, false, INTAKE_SIDE);
    robot.turn_with_pid(391.95, 800);
    cornerDeploy.overrideState(0);
    // moveManual(200, 8);
    /*
    robot.turn_to_point({(au::inches)(31.44), (au::inches)(-20.71)}, MOGO_SIDE, 900);
...
void Routes::placehold8() {
    ...
    //ELIMS ENDING
    // robot.turn_to_point({(au::inches)(47), (au::inches)(19)}, INTAKE_SIDE, 900); /*
    robot.move_to_point({(au::inches)(49.33), (au::inches)(25.68)}, true, INTAKE_SIDE, 800, 2.9);
    LiftMngr::setLevel(STRAIGHT_ARM);
    robot.chassis.left_motors.raw.set_brake_mode_all(pros::MotorBrake::hold);
    robot.chassis.right_motors.raw.set_brake_mode_all(pros::MotorBrake::hold);
    robot.turn_with_pid(137.4, 400);
    // moveManual(700, 8);
    // robot.turn_with_pid(-23.2, 600);
    //29.16, 29.82
    /**/
...
void Routes::placehold8Mir() {
    ...
    //ELIMS ENDING
    // robot.turn_to_point({(au::inches)(49.33), (au::inches)(-25.68)}, INTAKE_SIDE, 900); /*
    IntakeHelper::voltage(12);
    robot.turn_with_pid(185, 900);
    robot.move_to_point({(au::inches)(50.9), (au::inches)(-26.31)}, false, INTAKE_SIDE, 900, 2.9);
    IntakeHelper::voltage(0);
    LiftMngr::setLevel(STRAIGHT_ARM);
    robot.chassis.left_motors.raw.set_brake_mode_all(pros::MotorBrake::hold);
    robot.chassis.right_motors.raw.set_brake_mode_all(pros::MotorBrake::hold);
...
void Routes::placehold13Mir() {
    ...
    MogoUtils::getMogo(5, 2, 7, 800); //1100
